...
const Like = ({ product }) => {
  ...
  return (
    <button
      className="absolute z-10 right-3 top-2.5 cursor-pointer active:animate-ping active:transition-all active:duration-500 active:ease-in"
      onClick={toggleLike}
    >
      <svg
        width="20"
